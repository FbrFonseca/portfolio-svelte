...
>
    ...
    <a download="FabricioFonsecaCV" href="../assets/public/FabricioFonsecaCV.pdf" id="CV" target="_blank" class="gap-4 pr-3 duration-200 hover:text-violet-400">Dowload CV</a>
    <a 
